...
//     si visited;
//     queue.pb(make_pair(0, n));
//     while (!queue.empty()) {
//         auto [steps, tmp] = queue.front(); queue.pop_front();
//         if(tmp == m) {
//             cout << steps;
//             break;
//         }
...
//             queue.pb(make_pair(steps + 1, tmp - 1));
//         }
//         if (tmp < m && visited.count(tmp * 2) == 0) {
//             visited.insert(tmp - 1);
//             queue.pb(make_pair(steps + 1, tmp * 2));
//         };
//     };
// }
